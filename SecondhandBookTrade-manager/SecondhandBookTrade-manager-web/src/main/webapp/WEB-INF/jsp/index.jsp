...
<div class="leftnav">
  ...
  <ul style="display:block">
	...
	<li><a href="../hAdmin/index_v1.html" target="right"><span class="icon-caret-right"></span>用户管理</a></li>
  </ul>  
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="bookManage" name="right" width="100%" height="100%"></iframe>
</div>
